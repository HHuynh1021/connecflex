...
import { Box, HStack, Button, Text, IconButton, Menu, Avatar, Portal, Heading, Container, Stack, VStack} from '@chakra-ui/react'
    ...
    return (
        <Container>
            <Box>
                ...
                {isDesktop ? (
                    <Box>
                        <HStack justifyContent={"space-between"} fontWeight={"bold"} fontSize={"20px"} my={"20px"} p={"10px"} shadow={'sm'} rounded={"7px"}>
